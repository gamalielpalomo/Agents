...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Jun 07 16:51:28 CDT 2017
  */
public class SyntacticAnalyzer extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\005\000\002\004\003\000\002\002\004\000\002\004" +
    "\003\000\002\002\015\000\002\003\003" });
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\021\000\006\007\010\020\006\001\002\000\004\002" +
    "\023\001\002\000\004\002\001\001\002\000\004\002\ufffd" +
    "\001\002\000\004\002\uffff\001\002\000\004\022\011\001" +
    "\002\000\004\012\012\001\002\000\004\021\013\001\002" +
    "\000\004\005\014\001\002\000\004\021\015\001\002\000" +
    "\004\005\016\001\002\000\004\021\017\001\002\000\004" +
    "\021\020\001\002\000\004\006\021\001\002\000\004\021" +
    "\022\001\002\000\004\002\ufffe\001\002\000\004\002\000" +
    "\001\002" });
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\021\000\010\002\004\003\006\004\003\001\001\000" +
...
class CUP$SyntacticAnalyzer$actions {
  ...
  public final java_cup.runtime.Symbol CUP$SyntacticAnalyzer$do_action(
    ...
    System.out.print("Generic Instruction");
    event = new Event();
    instruction = new Instruction(Instruction.Command.NOTHING,event);

              CUP$SyntacticAnalyzer$result = parser.getSymbolFactory().newSymbol("nothing",1, ((java_cup.runtime.Symbol)CUP$SyntacticAnalyzer$stack.peek()), ((java_cup.runtime.Symbol)CUP$SyntacticAnalyzer$stack.peek()), RESULT);
            }
          return CUP$SyntacticAnalyzer$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 3: // create ::= SCHEDULE WORK AT INT SLASH INT SLASH INT INT DOUBLE INT 
            {
              Object RESULT =null;
