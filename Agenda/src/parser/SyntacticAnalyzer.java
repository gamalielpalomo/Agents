...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Aug 15 23:27:56 CDT 2017
  */
...
class CUP$SyntacticAnalyzer$actions {
  ...
  public final java_cup.runtime.Symbol CUP$SyntacticAnalyzer$do_action(
    ...
    event = new Event(hour, hour+1, day, day, "meeting");
    ...
    event = new Event(hour, hour+1, day, day, description);
    System.out.println("Comparing result: "+tools.EventComparator.checkSplice(event));
    instruction = new Instruction(Instruction.Command.SCHEDULE,event);
